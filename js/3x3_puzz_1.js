...
let items = [
    // Vegas
    { text: 'elvis', isImage: true, isURL: true, url: 'images/3x3_puzz_1_images/elvis.png', x: 120, y: 420, group: 'vegas', w: 105, h: 105, label: 'Elvis' },
    { text: 'Neon', isImage: false, x: 280, y: 170, group: 'vegas', w: 85, h: 50 },
    { text: 'slot', isImage: true, isURL: true, url: 'images/3x3_puzz_1_images/slots.png', x: 445, y: 440, group: 'vegas', w: 105, h: 105, label: 'Slot Machine' },
