...
winImage = loadImageFromURL('images/3x3_puzz_2_images/obama.png', 'winImage');
...
function draw() {
    ...
    textStyle(NORMAL);
    textSize(24);
    text('Conspiracy: OBAMA WASN\'T BORN IN AMERICA, OR AT ALL.', width / 2, height / 2 + 20);
    text('HE IS THE FIRST FETUS PRESIDENT', width / 2, height / 2 + 50);
    //textSize(20);
    ...
    text('HE IS THE FIRST FETUS PRESIDENT', width / 2, height / 2 + 50);
    textSize(16);
    text('Obama: white house, 43, hope', width / 2, height / 2 + 100);
    text('America: bald eagle, american flag, 1776', width / 2, height / 2 + 120);
    text('Fetus: ultrasound, trimester, pregnancy test', width / 2, height / 2 + 140);
    // textSize(20);
    ...
    fill(50);
    textSize(13);
    text('• Click and drag to make chains of 3 related items', 20, 645); // 4 LINE
