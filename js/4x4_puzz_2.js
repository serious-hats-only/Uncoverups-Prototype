...
winImage = loadImageFromURL('images/4x4_puzz_2_images/margaritaville.png', 'winImage');
...
function draw() {
    ...
    text('Bermuda: bermuda flag, bermuda shorts, bermuda island, bermuda grass', width / 2, height / 2 + 140);
    text('Triangle: pool rack, water-ski pyramid, research triangle, dorito', width / 2, height / 2 + 160);
    // textSize(20);
    ...
    fill(50);
    textSize(13);
    text('• Click and drag to make chains of 4 related items', 20, 645);
